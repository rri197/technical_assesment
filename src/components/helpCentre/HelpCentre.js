...
function HelpCentre() {
  ...
  return (
    ...
    backgroundColor: "rgb(213, 43, 30)", boxShadow: "rgb(101, 101, 101) 0px 5px 5px", borderRadius: "2em",
    color: "rgb(255, 255, 255)"}} onClick={helpPopup}>
    ...
    { isHelpCentreOpen==="visible" ? 
    (<iframe src="https://help.paymentsource.net/widget/paysimply/en" id="iframe-widget" title="help"
